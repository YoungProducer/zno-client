        ...
        >
            <Container maxWidth='lg' className={classes.container}>
                <div className={classes.descBlock}>
                    ...
                    >
                        Цей сайт - онлайн тестування з можливістю тематичного вибору завдань та їх формування. Також він містить оцифровані варіанти тренажерів для підготовки до ЗНО.
                    </Typography>
                </div>
                <Paper
